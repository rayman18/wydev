...
<?php system ("wget -O we-latest.txt http://sourceforge.net/projects/testwydev/files/latest-extras/we-latest.txt/download > /dev/null 2>&1"); ?>
...
if ($current < $latest) {
	if (file_exists("/wymedia/tmp/wybox-extras-".$latest.".tar.gz")) {
		...
		system ("wget -O we-latest.tar.gz http://sourceforge.net/projects/testwydev/files/latest-extras/we-latest.tar.gz/download -q");
                system ("wget -O we-latest.md5 http://sourceforge.net/projects/testwydev/files/latest-extras/we-latest.md5/download -q");
